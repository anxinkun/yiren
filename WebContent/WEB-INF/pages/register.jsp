			...
			<article id="article1">
				...
				<aside id="aside1">
					...
					<table id="table1">
						...
						<tr>
							<td><input type="text"  name="user_id" id="user_id" class="input1" placeholder="账号（例：蚁人音乐）" /><form:errors path="user_id"  /><span>${requestScope.msg}</span><br></td>
						</tr>
						<tr>
							<td></br></td>
					</tr>
						<tr>
							<td><input type="password" name="user_password" id="user_password"  class="input1" placeholder="密码（6-16个字符组成，区分大小写）"><form:errors path="user_password" /><br></td>
						</tr>
						...
						<tr>
							<td><input type="submit" value="注册" name="btnButton" class="bton bton-login"/></td>
						</tr>
					</table>
					</form:form>
				</aside>
